        ...
        <div className="row mt-4">
          <div className="col-md-6 offset-md-3">
            ...
            <div className="d-flex justify-content-between">
              <button className="btn btn-primary btn-lg" style={{ backgroundColor: '#007BFF' }} onClick={() => handleStartGame('X')}>
                X
              </button>
              <button className="btn btn-primary btn-lg" style={{ backgroundColor: '#FFC107' }} onClick={() => handleStartGame('O')}>
                O
              </button>
            </div>
          </div>
